...
export const metadata: Metadata = {
  ...
  description:
    "Transparent pricing for your AI Operating System. Free AI Operations Audit. Workflow automation from $2,500. Custom AI Workforce from $5,500. Built for small and medium businesses.",
